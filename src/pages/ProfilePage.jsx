...
export default function ProfilePage({ user, referral, referralDetails = [], config, showToast, setIsAdmin, isAdmin, walletConnected, disconnectWallet, connectWallet }) {
  ...
  const menu = [
    { Icon: Users, iconColor: '#0098EA', color: 'blue', label: 'REFERRAL PROGRAM', sub: `${referral?.friends || 0} referred users · ${formatTon(referral?.commission || 0)}`, action: () => setShowReferralPage(true) },
    walletConnected
    ...
    return (
      <div className="page page-enter">
        ...
        <div className="ref-page-header">
          ...
          <div>
            <div className="ref-page-title">REFERRAL PROGRAM</div>
        ...
        <div className="ref-detail card">
          <div className="rd-header">
            <div>
              <div className="rd-title">REFERRED USERS</div>
              <div className="rd-sub">Deposit volume and income generated by each referral.</div>
            </div>
          ...
          {referralDetails.length === 0 ? (
            <div className="rd-empty">
              ...
              <div>
                ...
                <div className="rd-empty-sub">Shared users will appear here after opening your referral link.</div>
              </div>
            </div>
          ) : (
