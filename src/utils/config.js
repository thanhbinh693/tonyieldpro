...
export const DEFAULT_PLANS = [
  { id: 1, name: 'Starter Yield', tier: 'Starter', min: 0.01, max: 0.99, rate: 2.5, duration: 1, durationUnit: 'hours', durationMs: 3_600_000, profitIntervalMinutes: 5, profitIntervalMs: 300_000, activeDays: [0, 1, 2, 3, 4, 5, 6], color: 'gold', hot: false },
  { id: 2, name: 'Pro Yield', tier: 'Pro', min: 1, max: 4.99, rate: 3.0, duration: 2, durationUnit: 'hours', durationMs: 7_200_000, profitIntervalMinutes: 15, profitIntervalMs: 900_000, activeDays: [0, 1, 2, 3, 4, 5, 6], color: 'blue', hot: true },
  { id: 3, name: 'VIP Yield', tier: 'VIP', min: 5, max: null, rate: 3.5, duration: 3, durationUnit: 'hours', durationMs: 10_800_000, profitIntervalMinutes: 30, profitIntervalMs: 1_800_000, activeDays: [0, 1, 2, 3, 4, 5, 6], color: 'purple', hot: false },
]
